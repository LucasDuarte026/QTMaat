...
namespace minas_control
{
    ...
    public:
        ...
        /**
         * \brief velocity setup to find switch (6099h / 01h)
         */
        void setSwitchSpeed(uint32_t val);

        /**
         * \brief velocity setup to find zero (6099h / 02h)
         */
        void setZeroSpeed(uint32_t val);

        void setHomingAcceleration(uint32_t val);

        void setHomingTorqueLimit(uint16_t val);

        void setHomingDetectionTime(uint16_t val);

        void setHomingDetectionVelocity(uint32_t val);

        void setHomingMode(uint8_t val);

        void setTouchProbe(uint16_t val);

        void setCommunicationFuntionExtendedSetup(uint16_t val);
        
        void setHomingReturnSpeedLimit(uint16_t val);
        /*
