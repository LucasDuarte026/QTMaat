...
static constexpr auto qt_meta_stringdata_ZN15AddSensorDialogE = QtMocHelpers::stringData(
    "AddSensorDialog",
    "validateInputs",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN15AddSensorDialogE[] = {
...
Q_CONSTINIT const QMetaObject AddSensorDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15AddSensorDialogE.offsetsAndSizes,
    qt_meta_data_ZN15AddSensorDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15AddSensorDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void *AddSensorDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15AddSensorDialogE.stringdata0))
