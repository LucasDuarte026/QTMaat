...
namespace {
struct qt_meta_tag_ZN10LogHandlerE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN10LogHandlerE = QtMocHelpers::stringData(
    "LogHandler"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10LogHandlerE[] = {
...
Q_CONSTINIT const QMetaObject LogHandler::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10LogHandlerE.offsetsAndSizes,
    qt_meta_data_ZN10LogHandlerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10LogHandlerE_t,
        // Q_OBJECT / Q_GADGET
...
void *LogHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10LogHandlerE.stringdata0))
