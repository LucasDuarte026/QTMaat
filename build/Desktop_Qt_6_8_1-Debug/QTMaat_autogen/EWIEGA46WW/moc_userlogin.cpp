...
static constexpr auto qt_meta_stringdata_ZN9UserLoginE = QtMocHelpers::stringData(
    "UserLogin",
    "onOkClicked",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9UserLoginE[] = {
...
Q_CONSTINIT const QMetaObject UserLogin::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9UserLoginE.offsetsAndSizes,
    qt_meta_data_ZN9UserLoginE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9UserLoginE_t,
        // Q_OBJECT / Q_GADGET
...
void *UserLogin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9UserLoginE.stringdata0))
