...
void SensorSelectionWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->sensorSelected((*reinterpret_cast< std::add_pointer_t<SensorData*>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (SensorSelectionWindow::*)(SensorData * );
...
// SIGNAL 0
void SensorSelectionWindow::sensorSelected(SensorData * _t1)
{
